...
;!
;!    puts@s	PTR const unsigned char  size(2) Largest target is 36
;!		 -> STR_6(CODE[19]), STR_5(CODE[19]), STR_4(CODE[19]), STR_3(CODE[19]), 
;!		 -> STR_2(CODE[25]), STR_1(CODE[36]), 
;!
...
;;  i               2    3[COMRAM] unsigned short 
;;  key             1    5[COMRAM] unsigned char 
...
l807:
;main.c: 24: unsigned char key;
;main.c: 25: unsigned short int i;
;main.c: 27: init_config();
	call	_init_config	;wreg free
	line	29
;main.c: 29: puts("Press any digital key:\n\r");
		movlw	low(STR_2)
	movwf	((c:puts@s)),c
	movlw	high(STR_2)
	movwf	((c:puts@s+1)),c
...
l809:
;main.c: 32: {
;main.c: 33: key = read_digital_keypad(1);
	movlw	(01h)&0ffh
...
l725:
;digital_keypad.c: 12: static unsigned char once = 1;
;digital_keypad.c: 14: if (detection_type == 1)
...
l727:
;digital_keypad.c: 15: {
;digital_keypad.c: 16: if (((PORTC & 0x0F) != 0x0F) && once)
...
l731:
;digital_keypad.c: 17: {
;digital_keypad.c: 18: once = 0;
	movlw	low(0)
	movwf	((c:read_digital_keypad@once)),c
	line	20
	
l733:
;digital_keypad.c: 20: return (PORTC & 0x0F);
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	goto	l14
...
l739:
;digital_keypad.c: 22: else if ((PORTC & 0x0F) == 0x0F)
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	xorlw	0Fh
	btfss	status,2
...
l743:
;digital_keypad.c: 27: else if (detection_type == 0)
...
l745:
;digital_keypad.c: 28: {
;digital_keypad.c: 29: return (PORTC & 0x0F);
	movf	((c:3970)),c,w	;volatile
	andlw	low(0Fh)
	goto	l14
...
l749:
;digital_keypad.c: 30: }
;digital_keypad.c: 32: return 0xFF;
	movlw	(0FFh)&0ffh
	goto	l14
...
l805:
;main.c: 19: puts("Key detection feedback using UART\n\r");
		movlw	low(STR_1)
	movwf	((c:puts@s)),c
	movlw	high(STR_1)
	movwf	((c:puts@s+1)),c
...
;;		 -> STR_6(19), STR_5(19), STR_4(19), STR_3(19), 
;;		 -> STR_2(25), STR_1(36), 
;; Auto vars:     Size  Location     Type
;;		None
;; Return value:  Size  Location     Type
